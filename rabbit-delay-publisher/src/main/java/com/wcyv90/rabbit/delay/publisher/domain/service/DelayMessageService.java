...
import static com.wcyv90.rabbit.delay.publisher.infra.config.DelayConfig.TTL_DELAY_EXCHANGE;
import static com.wcyv90.rabbit.delay.publisher.infra.config.DelayConfig.TTL_DELAY_ROUTE;
...
public class DelayMessageService {
    ...
    public <T> void sendByTTL(String eventType, T message, Long delayMilliseconds) {
        xMessageSender.sendDelayMsg(XMessage.discardableMsgBuilder()
                        .eventType(eventType)
                        .body(message)
                        .build(),
